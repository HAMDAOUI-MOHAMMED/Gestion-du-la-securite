...
def nslkdd(request):
    ...
    imgtrdata = prs.DiagCirculaire(traindata,"training nsl-kdd data")
    imgtsdata = prs.DiagCirculaire(testdata,"testing nsl-kdd data")
    ...
    imgtrattack = prs.DiagAttack(df_Attack_train_update,"training attack nsl-kdd data")
    imgtsattack = prs.DiagAttack(df_Attack_test_update,"testing attack nslkdd data")
    ...
    return render(request, 'nslKdd/nslkdd.html',context)